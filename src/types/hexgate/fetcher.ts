 ...
 * @internal
 */
export type OptionalEmptyArg<T extends (arg: any, init?: RequestInit) => any> = ((
  arg: Record<string, never>,
  init?: RequestInit
) => ReturnType<T>) extends T
 ...
 */
export type RequiredEmptyArg<T extends (arg: any, init?: RequestInit) => any> = ((
  arg?: Record<string, never>,
  init?: RequestInit
) => ReturnType<T>) extends T
  ? (arg: Exclude<Parameters<T>[0], undefined>, init?: RequestInit) => ReturnType<T>
  : T
 ...
 * @internal
 */
export type HexgateCreate<T, M> = OptionalEmptyArg<CreateFetch<M, T>>
